...
var getSummaryPromise = function (groupedOrders) {
    return Object.keys(groupedOrders).map(function (ticker) {
        return yahoo_finance2_1.default
            ...
            var _b = computeMetrics(groupedOrders[ticker]), totalCost = _b.totalCost, totalVolume = _b.totalVolume;
...
var getDividendPromise = function (groupedOrders) {
    return Object.keys(groupedOrders).map(function (ticker) {
        ...
        groupedOrders[ticker].map(function (_a) {
            ...
            dividends: lodash_1.sumBy(orderDivArr).toFixed(2),
        }); })
            .catch(function () { return ({ dividends: undefined }); });
    });
};
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var spinner, portfolio, groupedOrders, resolvedSummaryArr, resolvedDividendArr, zippedOutput, error_1, spinnerMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Promise.all(getSummaryPromise(groupedOrders))];
            case 2:
                resolvedSummaryArr = _a.sent();
                return [4 /*yield*/, Promise.all(getDividendPromise(groupedOrders))];
            case 3:
                resolvedDividendArr = _a.sent();
                zippedOutput = lodash_1.zipWith(resolvedSummaryArr, resolvedDividendArr, function (summary, dividend) { return (__assign(__assign({}, summary), dividend)); });
                spinner.succeed('Fetched successfully');
                helper_1.logSummary(zippedOutput);
                return [3 /*break*/, 5];
            case 4:
                error_1 = _a.sent();
                spinnerMessage = '';
                if (error_1 instanceof yahoo_finance2_1.default.errors.FailedYahooValidationError) {
                    spinnerMessage = 'Failed to validate Yahoo response';
                }
                else if (error_1 instanceof yahoo_finance2_1.default.errors.HTTPError) {
